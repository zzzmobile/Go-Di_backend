...
var design={
	...
	text:{
		...
		setValue: function(o){
			...
			if (typeof o.decoration != 'undefined' && o.decoration == 'underline')
				jQuery('#text-style-12').addClass('active');
			else
				jQuery('#font_picel').removeClass('active');
			...
			if (typeof o.decoration != 'undefined' && o.decoration == 'underline')
				jQuery('#text-style-14').addClass('active');
			else
				jQuery('#text-style-14').removeClass('active');

			if (typeof o.decoration != 'undefined' && o.decoration == 'underline')
				jQuery('#text-style-16').addClass('active');
			else
				jQuery('#text-style-16').removeClass('active');

			if (typeof o.decoration != 'undefined' && o.decoration == 'underline')
				jQuery('#text-style-18').addClass('active');
			else
				jQuery('#text-style-18').removeClass('active');

			if (typeof o.decoration != 'undefined' && o.decoration == 'underline')
				jQuery('#text-style-50').addClass('active');
			else
				jQuery('#text-style-50').removeClass('active');
			...
			if(typeof lable != 'undefined' && lable != '')
			{
				...
				switch(lable){
					...
					case 'styleU':
						...
						case 'pixcel_font':
						var font_picelss = $jd('#font_picel').val();
						//var o = $jd('#text-style-u');
						console.log(123456);
							//o.addClass('active');
							txt.css('font-size', font_picelss+'px');
							txt[0].setAttributeNS(null, 'y', font_picelss-1);
							//obj.item.decoration = 'underline';
					...
					case 'styleall':
						//var o = $jd('#text-style-u');
						var font_picelss = $jd('#font_picel').val();
						console.log(font_picelss);
						var o = $jd('#text-style-u');
						if(o.hasClass('active')){
							o.removeClass('active');
							txt.css('font-size', font_picelss+'px');
							txt[0].setAttributeNS(null, 'y', font_picelss-1);
							txt[0].setAttributeNS(null, 'font-size', font_picelss+'px');
							obj.item.decoration = 'none';
						}else{
							o.addClass('active');
							txt.css('font-size', font_picelss+'px');
						...
						if(o.hasClass('active')){
							...
							txt[0].setAttributeNS(null, 'y', 11);
							obj.item.decoration = 'none';
						}else{
							o.addClass('active');
							txt.css('font-size', '12px');
						...
						if(o.hasClass('active')){
							...
							txt[0].setAttributeNS(null, 'y', 13);
							obj.item.decoration = 'none';
						}else{
							o.addClass('active');
							txt.css('font-size', '14px');
						...
						if(o.hasClass('active')){
							...
							txt[0].setAttributeNS(null, 'y', 15);
							obj.item.decoration = 'none';
						}else{
							o.addClass('active');
							txt.css('font-size', '16px');
						...
						if(o.hasClass('active')){
							...
							txt[0].setAttributeNS(null, 'y', 17);
							obj.item.decoration = 'none';
						}else{
							o.addClass('active');
							txt.css('font-size', '18px');
						...
						if(o.hasClass('active')){
							...
							txt[0].setAttributeNS(null, 'y', 49);
							obj.item.decoration = 'none';
			...
			if (Object.keys(items.design).length > 0)
			{
				...
				jQuery.each(postions, function(i, view){					
					if (value[view] != '' && value[view].length > 0)
					{
						...
						if(i == 0){
							a.innerHTML = '<div style="padding:5px 10px;">Front</div>';
						}
						if(i == 1){
						a.innerHTML = '<div style="padding:5px 10px;">Back</div>';
							}
	...
	saveDesign: function(){
		...
		var card_type = '1';
		if ($("#card_type1").prop("checked")) {
		var card_type = '1';
		}else if ($("#card_type2").prop("checked")) {
		var card_type = '2';
		}else if ($("#card_type3").prop("checked")) {
		var card_type = '3';
		}else{
...
console.log('card_type',card_type);
		var deign_edit_id = document.getElementById('deign_edit_id').value;
		var price = document.getElementById('price').value;

		var category = document.getElementById('category').value;
		var background_color = document.getElementById('inlinecolors').value;

		var back_background_color = document.getElementById('inlinecolors1').value;
