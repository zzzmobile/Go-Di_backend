...
$_COOKIE['design']='8992d1b8b6e8ec5f0975eba68ed8d306';
$_COOKIE['lang']='en';
$_COOKIE['temail']='admin@gmail.com';
$_COOKIE['tpassword']='admin';
...
$mysqli_query12 = mysqli_query($con,"SELECT MAX(template_id) as id FROM  template");
$id=mysqli_fetch_assoc($mysqli_query12)[id];
//echo "SELECT MAX(template_id) FROM  template";die;
}
...
$image=$_FILES['image'];
      ...
      if(empty($errors)==true){
         move_uploaded_file($file_tmp,"uploaded/2018/05/".$newfilename);

         $path="uploaded/2018/05/".$newfilename;
         
         $mysqli_query = mysqli_query($con,"update template set 
					image='$path'					
...
{
	$user = 'c9b7dacd4b016232934a50fbb4c28b4a';
}
else
{
	$user = $_COOKIE['design'];
...
<head>
	...
	<?php echo $addons->css(); ?>
	<link rel="stylesheet" type="text/css" media="all" href="https://www.templatemonster.com/blog/wp-content/uploads/2014/02/demo/css/jquery.minicolors.css">
  <script type="text/javascript" src="https://www.templatemonster.com/blog/wp-content/uploads/2014/02/demo/js/jquery-1.10.2.min.js"></script>
  <script type="text/javascript" src="https://www.templatemonster.com/blog/wp-content/uploads/2014/02/demo/js/jquery.minicolors.min.js"></script>

	<script type="text/javascript" src="assets/js/jquery.min.js"></script>
	<script type="text/javascript" src="assets/plugins/jquery-ui/jquery-ui.min.js"></script><script>jQuery.noConflict();</script>
...
<?php
 ...
 // $result=mysqli_query($con,"SELECT * FROM template_categories");
 // $row=mysqli_fetch_row($result);
 // print_r($row);
// $commentsText = file_get_contents('cache/cart/d3f28a3e0a388547113f5d37b06e390d.txt');

// /* create array list from comments */
// $commentsList = json_encode($commentsText);
// //print_r($commentsList);




// $myfile = fopen("cache/cart/d3f28a3e0a388547113f5d37b06e390d.txt", "r") or die("Unable to open file!");
// $a= fread($myfile,filesize("cache/cart/d3f28a3e0a388547113f5d37b06e390d.txt"));
//$a= (string)fclose($myfile);
...
{
	$data_break=explode(':',$_GET['design']);
	$design_id=$data_break[1];
	$designer_id =$data_break[0];
}
