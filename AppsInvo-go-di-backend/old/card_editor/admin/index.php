            ...
            <div class="section">
               <div class="row">
                  ...
                  <div class="col s12 m6 h-right">
                    ...
                    <a onClick="javascript:saveastemplate()" href="#">Save As</a>
			...
			<form class="col s12" id="savetemplateform">
			  <div class="row">
				...
				<div class="input-field col s6">
				  ...
				  <label for="templatename">Business Card Name</label>
				</div>
			  </div>
       ...
       <!--  <h4>Canvas Width / Height</h4> -->
        <form class="col s12" id="canvaswhForm">
            <div class="row" style="display: none;">
              <div class="input-field col s6">
                <input id="loadCanvasWid" type="text" class="validate" required="" aria-required="true" value="3.2">
                <label for="loadCanvasWid">Canvas Width(in inches)</label>
              </div>
              <div class="input-field col s6">
                <input id="loadCanvasHei" type="text" class="validate" required="" aria-required="true" value="2">
            ...
            <div class="modal-footer">
              <button class="modal-action modal-close waves-effect waves-green btn" type="submit">Continue</button>
          </div>
          </form>
        </div>
      </div>
...
$(window).load(function() {
   ...
   // $('#canvaswh_modal').openModal({dismissible: false});
    //document.getElementById("canvaswhForm").submit();

    var button = document.getElementById('canvaswhForm');
    button.form.submit();
