	...
	background-color:#803D9B;
                  ...
                  <div class="x_content">
					...
					<div class="">
						  ...
						  <div class="dashbord col-md-3" style="margin-bottom: 30px;margin-top: 20px;">
								<center>
									...
									<p style="display: none;">${{ $category->price }}</p>
								</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					{{ Form::text('price', '100', ['id' => '', 'class' => 'form-control', 'placeholder' => 'Price*', 'required' => 'required']) }}
				</div>
	...
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group" style="display: none;">
					{{ Form::label('price', 'Price*', ['class' => 'form-control-label']) }}
					{{ Form::text('price', '100', ['id' => 'price', 'class' => 'form-control', 'placeholder' => 'Price*', 'required' => 'required']) }}
				</div>
			</div>
			<div class="modal-footer">
					{{ Form::button('Close', ['class' => 'btn btn-secondary', 'data-dismiss' => 'modal']) }}
